"use strict";(self.webpackChunkgrow_in_life=self.webpackChunkgrow_in_life||[]).push([[9866],{130:(e,t,r)=>{r.r(t),r.d(t,{default:()=>Ut});var o=r(5043),n=r(9615),i=r(4574);const l=i.Ay.div`
  margin: 0;
...
`;const Le=function(e){let{imageUrl:t,caption:r,altText:o}=e;return(0,h.jsxs)(Ee,{children:[t?(0,h.jsx)(Re,{src:t,alt:o||"\u0417\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u043d\u044f"}):(0,h.jsx)("p",{children:"\u0417\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u043d\u044f \u0432\u0456\u0434\u0441\u0443\u0442\u043d\u0454."}),r&&(0,h.jsx)(Te,{children:r})]})},Oe=i.Ay.div`
  width: 100%;
  overflow-x: auto;
...
`,it=e=>{let{headings:t,alignment:r}=e;return t&&0!==t.length?(0,h.jsx)(nt,{alignment:r,children:t.map(e=>(0,h.jsx)("li",{style:{marginLeft:15*(e.level-3)+"px"},children:(0,h.jsx)("a",{href:`#${e.id}`,children:e.title})},e.id))}):(0,h.jsx)("span",{children:"\u041d\u0435\u043c\u0430\u0454 \u043f\u0456\u0434\u0437\u0430\u0433\u043e\u043b\u043e\u0432\u043a\u0456\u0432"})},lt=i.Ay.div`
  display: flex;
  align-items: center;
  position: sticky;
  top: -79px;
...
`,mt=e=>{let{sections:t}=e;const[r,n]=(0,o.useState)(""),[i,l]=(0,o.useState)([]),s=(0,o.useRef)(null),a=(0,o.useRef)(null);(0,o.useEffect)(()=>{const e=Array.from(document.querySelectorAll("h2[id]"));if(0===e.length)return void l([]);const t=e.map(e=>{const t=(e=>{const t=[];let r=e.nextElementSibling;for(;r&&"h2"!==r.tagName.toLowerCase();)r.tagName.toLowerCase().startsWith("h")&&r.id&&t.push({id:r.id,title:r.textContent,level:parseInt(r.tagName.substring(1))}),r=r.nextElementSibling;return t})(e);return{id:e.id,title:e.textContent,nestedHeadings:t}});l(t)},[t]),(0,o.useEffect)(()=>{const e=Array.from(document.querySelectorAll("h2[id]"));if(0===e.length)return;const t=new IntersectionObserver(e=>{let t=null;const r=e.find(e=>e.isIntersecting);if(r)t=r.target.id;else{const r=e.filter(e=>!e.isIntersecting).sort((e,t)=>t.target.getBoundingClientRect().top-e.target.getBoundingClientRect().top);r.length>0&&(t=r[0].target.id)}t&&n(t)},{root:null,rootMargin:"0px 0px -80% 0px",threshold:0});return e.forEach(e=>{t.observe(e)}),()=>{t.disconnect()}},[t]),(0,o.useEffect)(()=>{if(r&&a.current){const e=a.current.querySelector(".active");e&&e.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"})}},[r]);const d=e=>{if(!a.current)return;const t=Array.from(a.current.children),r=t.findIndex(e=>e.querySelector(".active"));let o=r;"right"===e&&r<t.length-1?o=r+1:"left"===e&&r>0&&(o=r-1);const l=t[o];if(l){var s;const e=null===(s=i[o])||void 0===s?void 0:s.id;if(e){n(e),l.scrollIntoView({behavior:"smooth",block:"nearest",inline:"center"});const t=document.getElementById(e);t&&t.scrollIntoView({behavior:"smooth"})}}};return 0===i.length?null:(0,h.jsxs)(lt,{children:[(0,h.jsx)(st,{onClick:()=>d("left"),"aria-label":"\u041f\u0440\u043e\u043a\u0440\u0443\u0442\u0438\u0442\u0438 \u043d\u0430\u0432\u0456\u0433\u0430\u0446\u0456\u044e \u0432\u043b\u0456\u0432\u043e",children:(0,h.jsx)(rt.m6W,{size:24})}),(0,h.jsx)(at,{ref:s,children:(0,h.jsx)(dt,{ref:a,children:i.map(e=>{let{id:t,title:o,nestedHeadings:i}=e;return(0,h.jsx)(ct,{children:i.length>0?(0,h.jsx)(ot.A,{content:(0,h.jsx)(it,{headings:i}),alignment:"center",children:(0,h.jsx)(ut,{href:`#${t}`,className:r===t?"active":"",onClick:()=>n(t),children:o})}):(0,h.jsx)(ut,{href:`#${t}`,className:r===t?"active":"",onClick:()=>n(t),children:o})},t)})})}),(0,h.jsx)(st,{onClick:()=>d("right"),"aria-label":"\u041f\u0440\u043e\u043a\u0440\u0443\u0442\u0438\u0442\u0438 \u043d\u0430\u0432\u0456\u0433\u0430\u0446\u0456\u044e \u0432\u043f\u0440\u0430\u0432\u043e",children:(0,h.jsx)(rt.OQo,{size:24})})]})};var ht=r(8056);const pt=r.p+"static/media/photo-light3.4900a05613447ee31073.png",gt=r.p+"static/media/photo-dark3.f7a779db26d27647fa17.png",xt=function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[],r=[];return e.forEach((e,o)=>{const n=[...t,o];if(Array.isArray(e.title)&&"string"===typeof e.title[0]&&e.title[0].trim().length>0){const t=e.title[0],o=((e,t)=>{const r=Array.isArray(t)?t.join("-"):t;return"string"===typeof e&&e.trim()?`${e.trim().toLowerCase().replace(/[^a-z0-9\s-]/g,"").replace(/[\s-]+/g,"-")}-${r}`:`section-${r}`})(t,n);r.push({id:o,title:t,originalIndex:n})}"section-group"===e.type&&e.sections&&(r=r.concat(xt(e.sections,n)))}),r},bt=o.memo(e=>{let{lessonData:t}=e;const r=(0,i.DP)(),n=(0,o.useMemo)(()=>t&&t.sections?xt(t.sections):[],[t]);if(!t)return(0,h.jsx)("p",{children:"\u0417\u0430\u0432\u0430\u043d\u0442\u0430\u0436\u0435\u043d\u043d\u044f \u0443\u0440\u043e\u043a\u0443 \u0434\u043e\u043c\u0430\u0448\u043d\u044c\u043e\u0457 \u0433\u0440\u0443\u043f\u0438..."});const{title:l,author:s,book:c,chapter:u,verses:m,date:g,duration:x,theme:b,tags:f,description:$,sections:y}=t,j="#FEFBF2"===r.colors.background?pt:gt;return(0,h.jsxs)(ht.Sg,{children:[(0,h.jsx)(ht.KE,{$heroImage:j,children:(0,h.jsxs)(ht.R4,{children:[(0,h.jsx)("h1",{children:(0,h.jsx)(d.A,{tokens:l})}),(0,h.jsx)(p,{author:s,book:c,chapter:u,verses:m,date:g,duration:x,theme:b,tags:f})]})}),n.length>0&&(0,h.jsx)(mt,{sections:n}),(0,h.jsx)(ht.IZ,{children:(0,h.jsx)(a.A,{children:(0,h.jsxs)(ht.tG,{children:[(0,h.jsx)(ht.yO,{children:(0,h.jsx)(d.A,{tokens:$})}),(0,h.jsx)(et,{sections:y,allSectionsWithIds:n,parentIndex:[],level:2})]})})})]})});var ft=r(6841),$t=r(5003),yt=r(6139);const jt=/\[bold:(.*?)]/,wt=/\[italic:(.*?)]/,vt=/\[verse:([a-z0-9_]+(?::[\d:,-]+)*):([^\]]+)]/,kt=/\[link:([^:]+):([^\]]+)]/,At=/\[img:([^:]+):([^:]+):([^\]]+)]/,zt=/\[highlight:(.*?)]/,Ct=/\[quote:(.*?)]/,St=e=>{if("string"!==typeof e)return e;const t=new RegExp(`(${jt.source}|${wt.source}|${vt.source}|${kt.source}|${At.source}|${zt.source}|${Ct.source})`,"gi"),r=[];let o,n=0;for(;null!==(o=t.exec(e));){const t=e.slice(n,o.index);t&&r.push(t);const i=o[0];let l=null;if(jt.test(i)){const e=i.match(jt)[1];l={type:"bold",content:St(e)}}else if(wt.test(i)){const e=i.match(wt)[1];l={type:"italic",content:St(e)}}else if(zt.test(i)){const e=i.match(zt)[1];l={type:"highlight",content:St(e)}}else if(Ct.test(i)){const e=i.match(Ct)[1];l={type:"quote",content:St(e)}}else if(vt.test(i)){const e=i.match(vt);l={type:"bible-link",bibleRef:e[1],content:e[2]}}else if(kt.test(i)){const e=i.match(kt);l={type:"link",url:e[1],content:St(e[2])}}else if(At.test(i)){const e=i.match(At);l={type:"image",url:e[1],alt:e[2],caption:St(e[3])}}l&&r.push(l),n=o.index+i.length}const i=e.slice(n);return i&&r.push(i),r};var Bt=r(2016);const Yt=Bt.RZ(()=>Bt.KC([Bt.Yj(),Bt.YO(Bt.KC([Bt.Yj(),Bt.Ik({type:Bt.eu("bold"),content:Yt}),Bt.Ik({type:Bt.eu("italic"),content:Yt}),Bt.Ik({type:Bt.eu("bible-link"),bibleRef:Bt.Yj(),content:Bt.Yj()}),Bt.Ik({type:Bt.eu("link"),url:Bt.Yj(),content:Yt}),Bt.Ik({type:Bt.eu("image"),url:Bt.Yj(),alt:Bt.Yj(),caption:Yt}),Bt.Ik({type:Bt.eu("highlight"),content:Yt}),Bt.Ik({type:Bt.eu("quote"),content:Yt})]))])),It=Bt.Ik({title:Yt.optional()}),Et=It.extend({type:Bt.eu("text"),subtitle:Yt.optional(),content:Bt.YO(Yt)}),Rt=It.extend({type:Bt.eu("list"),items:Bt.YO(Yt)}),Tt=It.extend({type:Bt.eu("list-cards"),cards:Bt.YO(Bt.Ik({title:Yt,content:Yt,emoji:Bt.Yj().optional()}))}),Lt=It.extend({type:Bt.eu("highlight-box"),content:Yt,emoji:Bt.Yj().optional()}),Ot=It.extend({type:Bt.eu("question-prompt"),question:Yt,answer:Yt.optional(),emoji:Bt.Yj().optional()}),Pt=It.extend({type:Bt.eu("timeline"),events:Bt.YO(Bt.Ik({year:Bt.Yj().optional(),title:Yt,description:Yt.optional(),verses:Bt.YO(Yt).optional()}))}),qt=It.extend({type:Bt.eu("reveal-cards"),cards:Bt.YO(Bt.Ik({id:Bt.Yj(),emoji:Bt.Yj().optional(),title:Yt.optional(),content:Yt}))}),Dt=It.extend({type:Bt.eu("quiz"),id:Bt.Yj(),question:Yt,options:Bt.YO(Bt.Ik({text:Yt,isCorrect:Bt.zM(),rationale:Yt.optional()})),hint:Yt.optional()}),Ht=It.extend({type:Bt.eu("diagram"),chartType:Bt.Yj(),description:Yt.optional(),chartData:Bt.bz(),chartOptions:Bt.bz()}),Wt=It.extend({type:Bt.eu("image-placeholder"),description:Yt.optional(),imageUrl:Bt.Yj(),altText:Bt.Yj().optional(),caption:Yt.optional()}),Nt=It.extend({type:Bt.eu("description-with-image"),content:Bt.YO(Yt),imageUrl:Bt.Yj(),altText:Bt.Yj().optional(),caption:Yt.optional(),imagePosition:Bt.Yj().optional()}),_t=It.extend({type:Bt.eu("contrast-section"),items:Bt.YO(Bt.Ik({heading:Yt,content:Yt,emoji:Bt.Yj().optional(),type:Bt.Yj()}))}),Vt=It.extend({type:Bt.eu("table"),tableTitle:Yt.optional(),headers:Bt.YO(Yt),rows:Bt.YO(Bt.YO(Yt))}),Ft=Bt.RZ(()=>Bt.KC([Et.extend({type:Bt.eu("text")}),Tt.extend({type:Bt.eu("list-cards")}),Rt.extend({type:Bt.eu("list")}),Lt.extend({type:Bt.eu("highlight-box")}),Ot.extend({type:Bt.eu("question-prompt")}),Pt.extend({type:Bt.eu("timeline")}),qt.extend({type:Bt.eu("reveal-cards")}),Dt.extend({type:Bt.eu("quiz")}),Ht.extend({type:Bt.eu("diagram")}),Wt.extend({type:Bt.eu("image-placeholder")}),Nt.extend({type:Bt.eu("description-with-image")}),_t.extend({type:Bt.eu("contrast-section")}),Vt.extend({type:Bt.eu("table")}),Bt.Ik({type:Bt.eu("section-group"),title:Yt,sections:Bt.YO(Ft)})])),Mt=Bt.Ik({id:Bt.Yj(),title:Yt,shortTitle:Bt.Yj(),book:Bt.Yj(),bookInternalKey:Bt.Yj(),chapter:Bt.Yj(),verses:Bt.Yj(),date:Bt.Yj(),author:Bt.Yj(),duration:Bt.Yj(),tags:Bt.YO(Bt.Yj()),description:Yt.optional(),sections:Bt.YO(Ft)}),Kt=e=>{if("string"===typeof e)return St(e);if(Array.isArray(e))return e.map(e=>Kt(e));if("object"===typeof e&&null!==e){const t={};for(const r in e)Object.prototype.hasOwnProperty.call(e,r)&&(t[r]="type"===r||"chartType"===r?e[r]:Kt(e[r]));return t}return e},Zt=()=>{const{mainRef:e}=(0,n.KC)(),{selectedHomeGroupLesson:t,setSelectedHomeGroupLesson:r}=(0,$t.t)(),[i,a]=(0,o.useState)(null),[d,c]=(0,o.useState)(null),[u,m]=(0,o.useState)(!0),p=(0,n.zy)();return(0,o.useEffect)(()=>{if(!t){const e=(()=>{for(const e of yt.Z)if("old-testament-books"===e.id||"new-testament-books"===e.id){const t="old-testament-books"===e.id?yt.j9:yt.oC;for(const e of t){const t=ft.H[e.internalKey];if(t&&t.length>0)return t[0].id}}else if("thematic"===e.type||"special"===e.type){const t=ft.H[e.id];if(t&&t.length>0)return t[0].id}return null})();e?r(e):m(!1)}},[t,r]),(0,o.useEffect)(()=>{if(!t)return;(async()=>{m(!0),c(null);const e=(e=>{if(!e)return null;for(const t in ft.H){const r=ft.H[t];if(r){const t=r.find(t=>t.id===e);if(t)return t}}return null})(t);if(e&&e.loadLesson)try{const t=(await e.loadLesson()).default,{success:r,lesson:o,error:n}=(e=>{try{const t=Mt.parse(e);return{success:!0,lesson:Kt(t),error:null}}catch(d){return console.error("\u041f\u043e\u043c\u0438\u043b\u043a\u0430 \u0432\u0430\u043b\u0456\u0434\u0430\u0446\u0456\u0457 \u0443\u0440\u043e\u043a\u0443:",d.message),{success:!1,lesson:null,error:d.message}}})(t);r?a(o):(c(`\u041f\u043e\u043c\u0438\u043b\u043a\u0430 \u0432\u0430\u043b\u0456\u0434\u0430\u0446\u0456\u0457: ${n}`),a(null))}catch(r){console.error("\u041f\u043e\u043c\u0438\u043b\u043a\u0430 \u0437\u0430\u0432\u0430\u043d\u0442\u0430\u0436\u0435\u043d\u043d\u044f \u0430\u0431\u043e \u043f\u0430\u0440\u0441\u0438\u043d\u0433\u0443 \u0443\u0440\u043e\u043a\u0443:",r),c("\u041d\u0435 \u0432\u0434\u0430\u043b\u043e\u0441\u044f \u0437\u0430\u0432\u0430\u043d\u0442\u0430\u0436\u0438\u0442\u0438 \u0443\u0440\u043e\u043a. \u0421\u043f\u0440\u043e\u0431\u0443\u0439\u0442\u0435 \u043f\u0456\u0437\u043d\u0456\u0448\u0435."),a(null)}finally{m(!1)}else m(!1),a(null),c("\u0423\u0440\u043e\u043a \u043d\u0435 \u0437\u043d\u0430\u0439\u0434\u0435\u043d\u043e.")})()},[t]),(0,o.useLayoutEffect)(()=>{if(i&&e&&e.current){const t=sessionStorage.getItem(`scrollPosition-${p.pathname}`);if(t){const r=parseInt(t,10);e.current.scrollTop=r}}},[i,e,p.pathname]),(0,h.jsx)(l,{children:u?(0,h.jsx)(s,{children:"\u0417\u0430\u0432\u0430\u043d\u0442\u0430\u0436\u0435\u043d\u043d\u044f \u0443\u0440\u043e\u043a\u0443..."}):d?(0,h.jsx)(s,{children:d}):i?(0,h.jsx)(bt,{lessonData:i}):(0,h.jsx)(s,{children:"\u0411\u0443\u0434\u044c \u043b\u0430\u0441\u043a\u0430, \u043e\u0431\u0435\u0440\u0456\u0442\u044c \u0443\u0440\u043e\u043a \u0434\u043e\u043c\u0430\u0448\u043d\u044c\u043e\u0457 \u0433\u0440\u0443\u043f\u0438 \u0437\u0456 \u0441\u043f\u0438\u0441\u043a\u0443 \u0432 \u043c\u0435\u043d\u044e."})})};function Ut(){return(0,h.jsx)(Zt,{})}}}]);
//# sourceMappingURL=9866.025a504c.chunk.js.map